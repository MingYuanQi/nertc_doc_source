...
::: note note
若客户端调用 [`joinChannel`](https://doc.yunxin.163.com/nertc/api-refer/linux/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine.html#acc3f404cee7cd1b56b5019776dbb660a) 方法后未成功加入房间，服务端可能也会创建一个新的音视频房间。
:::
...
3. 接收端接受的是大流还是小流，是小流的话可以调用接口申请大流并关闭小流。
