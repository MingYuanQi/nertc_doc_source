...
- 每次仅支持设置单个视频水印，再次调用 [`setLocalVideoWatermarkConfigs`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#a45ecd234816646e288e420f0a3a4b346) 方法设置视频水印时，会覆盖之前的水印设置。
- 设置镜像模式时，水印不受镜像效果影响。
- V5.3.0 版本开始不再支持画布水印相关接口（`setLocalCanvasWatermarkConfigs` 和 `setRemoteCanvasWatermarkConfigs` ），建议您使用本文中的编码水印，从源头保证数据的真实性。


## 配置步骤

1. 调用 [`setLocalVideoWatermarkConfigs`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#a45ecd234816646e288e420f0a3a4b346) 方法设置视频水印，水印在本地视频预览与视频通话过程中均生效。调用此方法时，您需要设置 enabled、type 和 config 参数，相关参数的说明如下：
...
- 设置水印成功后，SDK 会返回 [`onLocalVideoWatermarkState`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_event_handler_ex.html#acff5c56e9b620b86d33db3a827783279) 水印状态回调。
- 若您成功设置水印后再次调整水印参数，但出现传参错误，SDK 会取消上一次水印并返回 [`onLocalVideoWatermarkState`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_event_handler_ex.html#acff5c56e9b620b86d33db3a827783279) 水印状态回调。
:::

2. 启用该方法后，SDK 会触发水印启用成功与否的 [`onLocalVideoWatermarkState()`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_event_handler_ex.html#acff5c56e9b620b86d33db3a827783279) 回调，并提供相关错误原因说明，具体请参考 <a href="https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/namespacenertc.html#a14a4bd97dafec1f6c2005e3898b4dad4" target="_blank">` NERtcLocalVideoWatermarkState`</a>。
...
设置 [`watermarkType`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/structnertc_1_1_n_e_rtc_video_watermark_config.html) 参数为 **`kNERtcWatermarkTypeImage`**，并通过 `imageWaterMark` 参数配置图片水印，图片水印详细的参数说明如下表所示。
...
设置 [`watermarkType`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/structnertc_1_1_n_e_rtc_video_watermark_config.html) 参数为 **`kNERtcWatermarkTypeText`**，并通过 `text_watermarks` 参数配置文字水印，文字水印详细的参数说明如下表所示。

| 参数 	| 参数说明 	|
|---	|---	|
| content 	| 指定文字水印内容。<br>设置为空时，表示不添加文字水印。 	|
| font_name	| 字体的名称。如果系统或应用中未安装该字体，则使用系统默认字体。 	|
...
设置 [`watermarkType`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/structnertc_1_1_n_e_rtc_video_watermark_config.html) 参数为 **`kNERtcWatermarkTypeTimestamp `**，并通过 `timestamp_watermark` 参数配置时间戳水印，时间戳水印详细的参数说明如下表所示。
...
| **方法** | **功能描述**|
|:--|:--|
|[`setLocalVideoWatermarkConfigs`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#a45ecd234816646e288e420f0a3a4b346)|设置水印|
|[`onLocalVideoWatermarkState`](https://doc.yunxin.163.com/nertc/api-refer/macOS/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_event_handler_ex.html#acff5c56e9b620b86d33db3a827783279)|是否成功设置水印的回调通知|
