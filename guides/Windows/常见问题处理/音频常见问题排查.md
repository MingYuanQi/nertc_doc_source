...
4. 排查发送端的相关 API 的值设置是否正确。
    - [adjustRecordingSignalVolume](https://doc.yunxin.163.com/docs/interface/NERTC_SDK/Latest/Android/html/classcom_1_1netease_1_1lava_1_1nertc_1_1sdk_1_1_n_e_rtc_ex.html#ae4988d9c805907f6ef89bd076b5c3170)：调节采集音量的大小。数值越大，音量越大，具体请参见[设置通话音量](https://doc.yunxin.163.com/nertc/guide/jUzMjAxNTc?platformId=50002)。
...
4. 监控通话质量并分析，具体请参见[质量数据监控](https://doc.yunxin.163.com/nertc/guide/TY4NTI3MjQ?platformId=50326)、[质量数据分析](https://doc.yunxin.163.com/nertc/guide/jk1Njg4MTA?platformId=50326)和[质量数据分析案例](https://doc.yunxin.163.com/nertc/guide/zgyOTk1Njc?platformId=50326)。
...
|  ^^ 	| 无声或音量小的用户的 uid。 	|
|  ^^	| 音频 Dump 文件。获取步骤请参见[获取音频 Dump 文件](https://doc.yunxin.163.com/nertc/guide/TA0NjAwMDY)。 	|
...
::: note note
关于**服务监控平台**如何使用，具体请参考[质量数据监控](/https://doc.yunxin.163.com/nertc/guide/TY4NTI3MjQ?platformId=50326)。
:::
