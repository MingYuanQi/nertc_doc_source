...
2. 排查发送端的问题。
    1. 检查用户 B 是否已调用 [`enableLocalVideo`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine.html#a57782589b573cf02bbfa836dace811c1)开启本地视频采集。
    ...
    3. 在服务监控平台查看视频上行帧率，如果上行帧率远低于 [`setVideoConfig`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#ac50b8b00d7237e518d3d785e63377340) 中设置的帧率，可能是相机有问题或手机性能有问题。


3. 排查接收端的问题。
    1. 检查用户 A 是否已调用 [`subscribeRemoteVideoStream`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine.html#a385748f3ea0003ec0eb49f925774ddac)订阅用户 B 的视频。
    2. 检查用户 A 是否已调用 [`setupRemoteVideoCanvas`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine.html#a16192ada0272bb48adc18848e68dc57d)设置用户 B 的画布。
...
1. 查看 [`setVideoConfig`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#ac50b8b00d7237e518d3d785e63377340) 中设置的分辨率是否和您的应用场景相匹配。
...
2. 在服务监控平台查看相关的通话质量数据，具体步骤请参见[监控通话质量](#监控通话质量)。
    1. 查看发送端的视频上行码率和接收端的下行码率，确认接收端接收的是大流还是小流。
        - 如果订阅的是小流，视频略微模糊是符合预期的，您可以调用[`subscribeRemoteVideoStream`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine.html#a385748f3ea0003ec0eb49f925774ddac)接口，将[`NERtcRemoteVideoStreamType`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/namespacenertc.html#af9a1648ac76c0c9682bdadeca2f5c80d)参数的值设置为`kNERtcRemoteVideoStreamTypeHigh`，订阅大流。
        - 如果订阅的是大流，请继续执行下一步。
...
2. 在服务监控平台查看相关的通话质量数据，具体步骤请参见[监控通话质量](#监控通话质量)。
    ...
    1. 查看视频上行帧率，如果上行帧率太低，请查看 [`setVideoConfig`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#ac50b8b00d7237e518d3d785e63377340) 设置的帧率是否正常。
