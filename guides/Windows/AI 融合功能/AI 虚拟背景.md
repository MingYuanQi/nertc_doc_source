...
<table>
    <tr>
        <th colwidth=“15%”><b>文件夹</b></th>
        <th colwidth=“15%”><b>文件</b></th>
        <th colwidth=“40%”><b>说明</b></th>
    </tr>
    <tr>
...
1. 初始化 `matting_service`。
    ...
    ```
2. 调用 [`setParameters`](https://doc.yunxin.163.com/nertc/api-refer/windows/doxygen/Latest/zh/html/classnertc_1_1_i_rtc_engine_ex.html#a4d39a81643f19979461ec0bb569f4a0d) 接口，将 `kNERtcKeyEnableVideoCaptureObserver` 的值设置为 `YES`，开启摄像头采集数据的回调。
...
3. 在图像数据回调中调用 `matting_service`。
    ...
    ```
4. （可选）如果使用 Qt Creator，为保证项目最终的执行文件可以运行，需要添加编译后处理命令。
     ...
     3. 添加后处理命令。示例如下：
        ...
        ![](https://yx-web-nosdn.netease.im/quickhtml%2Fassets%2Fyunxin%2Fdoc%2FG2-VirtualBackground-Win01.png)
