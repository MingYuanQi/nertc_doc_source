...
- 公有云方式部署在云信公有云服务器上，可以降低用户 IT 岗位运维工作的维护成本，只需要配置云代理服务器白名单，不再需要根据云信服务器的增加而多次配置。
    ...
    ::: note note
    仅 V5.4.0 及之后版本的 NERTC SDK 支持此功能，请根据需要前往[网易云信 SDK 下载中心](https://doc.yunxin.163.com/nertc/sdk-download)获取最新版本的 SDK。
    :::
...
2. 调用 SDK API。
    ...
    1. 调用 [`SetCloudProxy`](https://doc.yunxin.163.com/nertc/api-refer/unity/doxygen/V5.4.5/zh/html/classnertc_1_1_i_rtc_engine.html#a693f01df30f2509b1bfd977bc1771a31) 接口，开通云代理设置。

        成功连接云代理后，SDK 会触发 [`OnConnectionStateChange`](https://doc.yunxin.163.com/nertc/api-refer/unity/doxygen/V5.4.5/zh/html/namespacenertc.html#a5224347f7502219af3cbfedb804e14bf) 回调。
    ::: note note
