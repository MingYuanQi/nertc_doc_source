...
::: note note
示例项目需要在 **RTC 调试模式**下使用，此时无需传入 Token。修改鉴权方式的方法请参见 <a href="https://doc.yunxin.163.com/nertc/quick-start/TQ0MTI2ODQ?platform=android" target="_blank">Token 鉴权</a> 。调试模式建议只在集成开发阶段使用，请在应用正式上线前改回安全模式。
:::
...
::: details 1. 编译时提示 “NDK not configured”，或 “No toolchains found in the NDK toolchains folder for ABI with prefix: mips64el-linux-android”
...
::: details 2. 手机连接电脑后，Android Studio 中没有出现对应的手机
