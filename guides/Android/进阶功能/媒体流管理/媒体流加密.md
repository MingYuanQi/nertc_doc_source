...
```
//step1:定义Cipher
private Cipher audioPktEncoder = Cipher.getInstance("RC4");
audioPktEncoder.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(gmEncryptKey.getBytes(), "RC4"));
private Cipher videoPktEncoder = Cipher.getInstance("RC4");
videoPktEncoder.init(Cipher.ENCRYPT_MODE, new SecretKeySpec(gmEncryptKey.getBytes(), "RC4"));
private Cipher audioPktDecoder = Cipher.getInstance("RC4");
audioPktDecoder.init(Cipher.DECRYPT_MODE, new SecretKeySpec(gmEncryptKey.getBytes(), "RC4"));
private Cipher videoPktDecoder = Cipher.getInstance("RC4");
videoPktDecoder.init(Cipher.DECRYPT_MODE, new SecretKeySpec(gmEncryptKey.getBytes(), "RC4"));
...
private NERtcPacketObserver mPacketObserver =  new NERtcPacketObserver() {
    ...
    public boolean onSendAudioPacket(NERtcPacket packet) {
        ...
        try {
            byte[] output = audioPktEncoder.doFinal(txAudioPktBuffer, 0, size);
            data.rewind();
            data.put(output);
            packet.setData(data);
            packet.setSize(output.length);
    ...
    public boolean onSendVideoPacket(NERtcPacket packet) {
        ...
        try {
            byte[] output = videoPktEncoder.doFinal(txVideoPktBuffer, 0, size);
            data.rewind();
            data.put(output);
            packet.setData(data);
            packet.setSize(output.length);
    ...
    public boolean onReceiveAudioPacket(NERtcPacket packet) {
        ...
        try {
            byte[] output = audioPktDecoder.doFinal(rxAudioPktBuffer, 0, size);
            data.rewind();
            data.put(output);
            packet.setData(data);
            packet.setSize(output.length);
    ...
    public boolean onReceiveVideoPacket(NERtcPacket packet) {
        ...
        try {
            byte[] output = videoPktDecoder.doFinal(rxVideoPktBuffer, 0, size);
            data.rewind();
            data.put(output);
            packet.setData(data);
            packet.setSize(output.length);
