...
::: note note
本文档主要介绍经典的音视频推荐配置，若还需要了解更多的详细参数配置，请参考 [设置音频属性](https://doc.yunxin.163.com/nertc/guide/Tc3OTYwMzc?platform=iOS) 和 [设置视频属性](https://doc.yunxin.163.com/nertc/guide/zcwMTY4MzM?platform=iOS)。
:::

## <span id="注意事项">注意事项</span>
- 同一个房间内的用户，建议使用同一种房间场景，以获得最佳效果。
- 若您的 App 有多种音视频业务场景，例如，同时有 1v1 音视频通话场景和标准语聊房场景。您可以在不销毁引擎  (destroyEngine) 的前提下，在退出房间后, 通过 [`setChannelProfile`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#aeb1ddb3e3ea5c8ddd6c2a9052a596410) 切换场景，然后再登录其他房间。
- 设置场景会影响音视频码率、帧率、视频分辨率、视频大小流模式、自动打开视频、自动订阅视频、传输策略。
- 调用 [`setChannelProfile`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#aeb1ddb3e3ea5c8ddd6c2a9052a596410)将覆盖上一次调用此函数设置的场景。
- 调用 [`setChannelProfile`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#aeb1ddb3e3ea5c8ddd6c2a9052a596410) 函数设置场景类型为视频 1对1 呼叫场景、清晰度较高的 1对1 呼叫场景等 v5.5.40 新增的房间场景将覆盖您通过  [`setLocalVideoConfig`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#a040ee549ad4a2b1d74d275defda38140)和 [`setAudioProfile`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#acbe79c3a3439b464314046d9638006ae) 等 API 设置的音视频相关配置，因此建议先第一时间设置场景再通过其他 API 调整音视频配置。
- 版本 v5.5.40 之前就存在通信场景和直播场景，设置通信场景和直播场景，不会覆盖 [`setLocalVideoConfig`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#a040ee549ad4a2b1d74d275defda38140) 和 [`setAudioProfile`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/protocol_i_n_e_rtc_engine-p.html#acbe79c3a3439b464314046d9638006ae) 等 API 设置的音视频相关配置。

## <span id="实现方式">实现方式</span>

设置房间场景参数中的 `channelProfile` ([`NERtcChannelProfileType`](https://doc.yunxin.163.com/nertc/references/iOS/doxygen/Latest/zh/html/_n_e_rtc_engine_enum_8h.html#ac0b3e90736033b48ac1ddfe938c02db3))字段指定一个场景，您可以根据实际音视频业务场景来选择。
